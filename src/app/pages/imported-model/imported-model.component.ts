...
@Component({
  selector: 'app-imported-model',
  templateUrl: './imported-model.component.html',
  styleUrls: ['./imported-model.component.scss']
})

export class ImportedModelComponent implements OnInit, AfterViewInit {
 ...
 */
  private startRenderingLoop() {
    ...
    let component: ImportedModelComponent = this;
    (function render() {
